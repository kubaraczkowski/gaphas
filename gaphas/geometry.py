...
def intersect_line_line(line1_start, line1_end, line2_start, line2_end):
    ...
    (478.0, 140.98167539267016)
    >>> intersect_line_line((527.5, 141.5), (336.5, 139.5), (478.0, 117.0), (478.0, 166.0))
    (478.0, 140.98167539267016)

    >>> intersect_line_line((5.0, 5.0), (25.0, 5.0), (10.0, 0.0), (10.0, 10))
    (10.0, 5.0)

    >>> intersect_line_line((15.0, 5.0), (25.0, 5.0), (10.0, 0.0), (10.0, 10))

    Python implementation of an algorithm by Paul Borke
    <http://paulbourke.net/geometry/lineline2d/>.
    """
    global abs, map, float
    EPS = 1e-6
    x1, y1 = map(float, line1_start)
    x2, y2 = map(float, line1_end)
    x3, y3 = map(float, line2_start)
    x4, y4 = map(float, line2_end)
